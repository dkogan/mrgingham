...
mrgingham-from-image - Extract chessboard corners from a set of images

=head1 SYNOPSIS

 $ mrgingham-from-image --chessboard --clahe --level 1 /tmp/image*.jpg
...
The general usage is
 ...
 mrgingham-from-image [--debug] [--jobs N] [--clahe] [--blur radius]
...
If given, C<mrgingham-from-image> will dump various intermediate results into
