...
Note: these pdf files are meant to be scaled, and printed to whatever size is
desired. The size of each square should then be measured, and communicated to
